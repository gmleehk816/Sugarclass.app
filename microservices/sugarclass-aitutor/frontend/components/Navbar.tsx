...
const Navbar: React.FC<NavbarProps> = ({ onNewChat, onToggleSidebar, onOpenSettings, systemStatus = 'checking', selectedSubject }) => {
    ...
    <nav className="fixed top-0 left-0 right-0 z-50 flex justify-center p-4 transition-all duration-500 ease-in-out pointer-events-none">
      ...
      >
        ...
        <div className="flex items-center gap-2 md:gap-3">
          ...
          <button onClick={onOpenSettings} className="p-2 rounded-full hover:bg-black/5 transition-colors text-main">
