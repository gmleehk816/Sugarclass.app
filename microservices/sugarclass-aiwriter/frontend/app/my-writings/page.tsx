...
import { BookOpen, Calendar, Trash2, Edit3, FileText, Loader2, ChevronDown, ChevronUp } from 'lucide-react'
        ...
        <div className="min-h-screen bg-background pb-12">
            ...
            <div className="bg-surface border-b border-border">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                    ...
                    <p className="text-text-secondary">All your saved news article writings</p>
                </div>
            </div>
