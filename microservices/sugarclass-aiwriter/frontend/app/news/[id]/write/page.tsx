...
import { ArrowLeft, Save, Wand2, Sparkles, Bot, Loader2, CheckCircle2, BookOpen, Lightbulb, Edit3, X, ChevronDown, ChevronUp, SpellCheck, GraduationCap, AlertCircle, Glasses, Palette } from 'lucide-react'
    ...
    async function handleSave() {
        ...
        try {
            const response = await saveWriting({
                ...
                writing_id: currentWritingId  // Include writing_id to update existing writing
            })

            if (response.success) {
                // Update the writing_id if it was a new save (no existing writing_id)
                if (!currentWritingId && response.writing_id) {
